                  ...
                  .map(
                    (email) =>
                      `<li style="display: flex; align-items: center; margin-bottom: 4px;">
                        ...
                        <button class="delete-participant-btn" title="Remove participant" data-activity="${name}" data-email="${email}" style="background: none; border: none; color: #d32f2f; cursor: pointer; font-size: 1.2em; margin-left: 8px;">
                          <span aria-label="Delete" style="pointer-events: none;">&#128465;</span>
                        </button>
                      </li>`
                  )
                  .join("")}
